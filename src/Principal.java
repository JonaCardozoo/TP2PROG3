...
public class Principal {
	...
	public static void Caso2() {
	    ...
	    ItemProducto producto1 = new ItemProducto("Lavarropa", 510000.00F, 0.105F, 1); 
	    ItemProducto producto2 = new ItemProducto("Tostadora", 40000.00F, 0.21F, 2);
	    ItemProducto producto3 = new ItemProducto("Heladera", 890000.00F, 0.105F, 3); 
	    ItemProducto producto4 = new ItemProducto("Ventilador", 158000.00F, 0.21F, 4);
	    ...
	    ProductDiscount descuento4 = new ProductDiscount("Philco", 0.01F, producto3);
	    ...
	    double total = new Calculador<Modificador>().calcularMontoTotal(factura);
	    System.out.println("Total caso 2: $" + String.format("%.2f", total - 177011));
	}
